...
Welcome! This repo is the sprint-phase project for the freeCodeCamp/NHCarrigan
...
`area:tests`, `area:docs`) so you can filter to what you want to practice.
...
There's no enforced linter/formatter config in this starter repo yet - match
the style of the surrounding code (the existing routes and components are a
good reference). If you want to add linting/formatting as your issue, that's
a welcome contribution too - open an issue for it first.
